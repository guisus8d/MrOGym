...
class App {
  ...
  async render(request, renderOptions) {
    ...
    clientAddress = renderOptions?.clientAddress ?? Reflect.get(request, clientAddressSymbol$1);
